...
function ContactField({ label, placeholder, multiline }) {
  const fieldClass =
    "w-full border-b-2 border-outline-variant bg-surface-container-lowest px-4 py-3 font-mono text-primary outline-none transition-colors placeholder:text-surface-container-highest focus:border-secondary";
  ...
  return (
    <div className="space-y-3">
      ...
      {multiline ? (
        ...
        <input className={fieldClass} placeholder={placeholder} type="text" />
      )}
    </div>
  );
}
...
export default function ContactPage() {
  return (
    ...
    >
      <main className="mx-auto grid max-w-7xl grid-cols-1 gap-12 px-6 pb-40 pt-32 md:px-12 lg:grid-cols-12">
        ...
        <section className="lg:col-span-7">
          <div className="group relative">
            ...
            <div className="relative overflow-hidden rounded-2xl border border-outline-variant/10 bg-surface-container-lowest shadow-2xl">
              ...
              >
                <ContactField label="Sender Name" placeholder="guest_user_01" />
                <ContactField label="Subject" placeholder="protocol_initiation" />
                <ContactField
                  label="Message Body"
                ...
                <div className="flex flex-col justify-between gap-6 pt-4 md:flex-row md:items-center">
                  ...
                  <button
                    className="group relative overflow-hidden rounded-lg px-8 py-3 font-headline font-bold uppercase tracking-tighter text-on-primary"
                    type="submit"
                  >
      ...
      <section className="relative mt-20 h-[400px] w-full overflow-hidden grayscale contrast-125 opacity-40 transition-opacity duration-1000 hover:opacity-100">
